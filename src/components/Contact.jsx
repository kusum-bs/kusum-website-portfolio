  ...
  return (
   <section id="contact">
    <div className="mx-auto max-w-6xl">
        ...
        text-lime-300 lg:pt-6 lg:text-5xl">{CONTACT.email}</p>
        <p className="my-4 text-center text-2xl font-medium 
        text-lime-300 lg:pb-6 lg:text-5xl">{CONTACT.phone}</p>
    </div>
    ...
    <p className="my-8 text-center text-gray-400 ">&copy; kusumbs. All rights reserved.</p>
   </section>
  );
};
